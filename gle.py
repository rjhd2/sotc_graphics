...
def read_hovmuller(filename):
    ...
    # Jan 1980 to December 2016
    times = np.arange(1980, 2017, 1./12)
...
utils.plot_smooth_map_iris(image_loc + "GLE_{}_anoms".format(settings.YEAR), cube, settings.COLOURMAP_DICT["hydrological"], bounds, "Anomalies from 1980-2016 (mm year"+r'$^{-1}$'+")")
utils.plot_smooth_map_iris(image_loc + "p2.1_GLE_{}_anoms".format(settings.YEAR), cube, settings.COLOURMAP_DICT["hydrological"], bounds, "Anomalies from 1980-2016 (mm year"+r'$^{-1}$'+")", figtext = "(r) Global Land Evaporation")
