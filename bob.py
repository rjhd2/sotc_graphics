...
data_loc = "{}/{}/data/BOB/".format(settings.ROOTLOC, settings.YEAR)
...
#    cube_list = iris.load(data_loc + "anomaly{}from2003-{}_coarse20.grb".format(settings.YEAR, int(settings.YEAR)-1))
    cube_list = iris.load(data_loc + "anomaly{}from2003-{}_coarse20.grb".format(settings.YEAR, 2010))
    ...
    utils.plot_smooth_map_iris(image_loc + "BOB_anomalies{}".format(settings.YEAR), cube, settings.COLOURMAP_DICT["land_surface"], bounds, "Anomalies from 2003-{} (g C m".format(2010)+r'$^{-2}$'+" yr"+r'$^{-1}$'+")")
    utils.plot_smooth_map_iris(image_loc + "p2.1_BOB_anomalies{}".format(settings.YEAR), cube, settings.COLOURMAP_DICT["land_surface"], bounds, "Anomalies from 2003-{} (g C m".format(2010)+r'$^{-2}$'+" yr"+r'$^{-1}$'+")", figtext="(ag) Carbon Emissions from Biomass Burning")
